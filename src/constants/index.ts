import { INavBarLink, ILinkIcon, IProject, iconMap } from "@/types";

function getLinkIcon(icon: keyof typeof iconMap, href: string, ffor: string): ILinkIcon {
    return {
        icon,
        href,
        for: ffor
...
function LinkedinLink(href: string): ILinkIcon {
    return getLinkIcon("FaLinkedin", href, "linkedin");
}

function GithubLink(href: string): ILinkIcon {
    return getLinkIcon("FaGithub", href, "github");
}

function DiscordLink(href: string): ILinkIcon {
    return getLinkIcon("FaDiscord", href, "discord");
}

function LiveLink(href: string): ILinkIcon {
    return getLinkIcon("MdLiveTv", href, "live");
}
...
export const PersonalLinks: ILinkIcon[] = [
    LinkedinLink("https://www.linkedin.com/in/djaoued-mohammed-bouhadda-802280284/"),
    DiscordLink(""),
    GithubLink("https://github.com/DjoCoding")
]
...
export const PersonalProjects: IProject[] = [
    {
        ...
        links: [
            GithubLink("https://github.com/DjoCoding/regex")
        ]
    },
    {
        ...
        links: [
            GithubLink("https://github.com/DjoCoding/Moathiq"),
            LiveLink("https://moathiq-mvp.vercel.app/")
        ]
    },
    {
        ...
        links: [
            GithubLink("https://github.com/DjoCoding/c8")
        ]
    },
    {
